...
void ssd1306_TestFonts1() {
    ...
    ssd1306_SetCursor(2, y);
    ssd1306_WriteString("Font 5x7", Font_5x7, White);
    #endif
...
void ssd1306_TestRectangle() {
  ...
  for(delta = 0; delta < 5; delta ++) {
    //ssd1306_DrawRectangle(1 + (5*delta),1 + (5*delta) ,SSD1306_WIDTH-1 - (5*delta),SSD1306_HEIGHT-1 - (5*delta),White);       //CAA update Coordinates
  }
  ssd1306_UpdateScreen();
  return;
}
